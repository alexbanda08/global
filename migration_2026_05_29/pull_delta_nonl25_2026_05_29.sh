#!/bin/bash
# Non-L25 top-off from VPS3: 2026-05-28 00:00 UTC -> NOW.
# Overlaps previous canonical (max ~May 28 20:03) by ~20h for safety.
set -euo pipefail

T_START_US=1779926400000000          # 2026-05-28 00:00 UTC
TAG=2026_05_29
echo "============================================="
