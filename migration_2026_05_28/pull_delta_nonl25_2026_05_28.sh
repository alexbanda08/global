#!/bin/bash
# Non-L25 top-off from VPS3: 2026-05-27 00:00 UTC -> NOW.
# Overlaps with previous canonical (max ~May 27 13:32) by ~13.5h for safety.
set -euo pipefail

T_START_US=1779840000000000          # 2026-05-27 00:00 UTC
TAG=2026_05_28
echo "============================================="
...
# 7. HL klines + trades + liqs (column names already correct)
