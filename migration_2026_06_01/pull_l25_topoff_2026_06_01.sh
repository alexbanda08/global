#!/bin/bash
# L25 top-off from VPS3: 2026-05-31 00:00 UTC -> NOW.
# Overlaps previous canonical (L25 max ~May 31 14:23-14:29) by ~14h for safety.
set -euo pipefail

T_START_US=1780185600000000          # 2026-05-31 00:00 UTC
TAG=2026_06_01_topoff
echo "============================================="
