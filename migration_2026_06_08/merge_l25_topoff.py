...
Streams [canonical {asset}.parquet, refresh_2026_06_08 delta] -> max_seen dedup ->
ParquetWriter (row_group_size=200_000) -> temp -> atomic replace.
"""
...
DELTA_DIR = DATA / "refresh_2026_06_08" / "cache"
