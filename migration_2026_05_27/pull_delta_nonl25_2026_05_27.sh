#!/bin/bash
# Non-L25 top-off from VPS3: 2026-05-26 00:00 UTC -> NOW.
# Overlaps with previous canonical (max ~May 26 17:37) by ~17h for safety.
set -euo pipefail

T_START_US=1779753600000000          # 2026-05-26 00:00 UTC
TAG=2026_05_27
echo "============================================="
