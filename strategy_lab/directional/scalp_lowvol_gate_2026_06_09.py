"""
LOW-VOL GATE on the open exit-scalp  —  2026-06-09  (THREAD C)
...
Vol = std of 1s binance log-returns, trailing 300s, causal (recomputed per fire). Reuses the saved gated OOS
fires (scalp_oos_bbo_fires_2026_06_05*.parquet, BBO Mar30-Apr21, 6 coins). Light: klines only, no BBO reload.
"""
import sys, glob
