# GPU LSTM — ETHUSDT_4h (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.503** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **-2.03**   vs buy&hold Sharpe -0.75
- n_test=2877, trades=2
