# GPU LSTM — BTC_1h_smoke (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.513** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **0.00**   vs buy&hold Sharpe 1.20
- n_test=1262, trades=0
