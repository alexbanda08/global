# GPU LSTM — SOLUSDT_15m (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.507** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **-0.03**   vs buy&hold Sharpe -0.62
- n_test=30501, trades=62
