# GPU LSTM — ETHUSDT_1h (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.512** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **-1.32**   vs buy&hold Sharpe -0.36
- n_test=11527, trades=218
