# GPU LSTM — SOLUSDT_1h (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.504** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **0.00**   vs buy&hold Sharpe -1.27
- n_test=7619, trades=0
