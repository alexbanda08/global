# GPU LSTM — ETHUSDT_15m (underlying-crypto direction) — auto

Device=cuda. SEQ=64, next-bar direction. Walk-forward train70/val15/**test15** (held out).

- Test directional accuracy: **0.519** (0.50 = coin-flip)
- OOS strategy Sharpe (pos=conf>0.55, 5bps): **-4.57**   vs buy&hold Sharpe -0.18
- n_test=46128, trades=7633
