...
JOBS = [
    ...
    ("0xb945945d", "0xb945945d5bcaf7b56834d4da8cdf8f8f94b2db68", 1787227200),  # refs: since Aug-20 12:00
    ("0xb27bc932", "0xb27bc932bf8110d8f78e55da7d5f0497a18b5b82", 1787227200),
    ("0x1b58d3de", "0x1b58d3de60d7f9e1aefdc9449e8d3733ea096f11", 1787227200),
    ("0x21d0a97a", "0x21d0a97aac03917e752857a551bbe5103a00e8d7", 1787227200),
]
for short, full, since in JOBS:
    ...
    for typ in ("TRADE", "REDEEM"):
        ...
        json.dump(recs, open(os.path.join(outdir, f"activity_{typ}_2026_08_20b.json"), "w"))
