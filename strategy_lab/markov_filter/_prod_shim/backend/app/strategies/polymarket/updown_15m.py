"""Updown15mStrategy — sig_ret5m Binance-latency-arbitrage signal (Phase 18.1).
...
class Updown15mStrategy(PolymarketBinaryStrategy):
    """sig_ret5m strategy for 15m markets: bet sign of Binance 5m return.
