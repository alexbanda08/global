...
async def build_bar_context_t_plus_120(
    ...
    btc_at_ws, btc_at_120, ret_2m_samples, cid, rsi_14 = await asyncio.gather(
...
async def build_bar_context_t_plus_60(
    ...
    btc_at_ws, btc_at_ws_minus_60, btc_at_60, ret_2m_v2_samples, cid, rsi_14 = await asyncio.gather(
