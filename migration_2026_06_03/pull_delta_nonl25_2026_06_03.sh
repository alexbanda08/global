#!/bin/bash
# Non-L25 top-off from VPS3: 2026-05-31 12:00 UTC -> NOW.
# Overlaps previous canonical (max ~Jun 1 09:03) by ~21h for safety.
set -euo pipefail

T_START_US=1780228800000000          # 2026-05-31 12:00 UTC (python: int(datetime(2026,5,31,12,0,0,tzinfo=timezone.utc).timestamp())*1_000_000)
TAG=2026_06_03
echo "============================================="
echo " VPS3 non-L25 top-off: T_START -> NOW"
echo " Tag: ${TAG}"
echo "============================================="
