"""
Merge non-L25 deltas from refresh_2026_06_03/cache/ into canonical/.
Rebuilds resolutions_from_rtds at the end. (L25 merged separately.)
"""
...
df2 = pd.read_parquet(CANON / "trading_events_30d.parquet")
log(f"  trading_events_30d        {len(df2):>10,} rows")
