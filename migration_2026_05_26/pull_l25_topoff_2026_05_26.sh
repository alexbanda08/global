#!/bin/bash
# L25 top-off from VPS3: May 25 18:00 UTC -> NOW.
# Overlaps with refresh_2026_05_25 (which ended ~May 25 19:13) by ~1h for safety.
# Limited to BTC/ETH/SOL up-down markets only.
