"""Convert L25 top-off CSVs to parquet for refresh_2026_05_26/cache/."""
...
RAW = ROOT / "data" / "v4" / "refresh_2026_05_26" / "raw"
CACHE = ROOT / "data" / "v4" / "refresh_2026_05_26" / "cache"
CACHE.mkdir(parents=True, exist_ok=True)
TAG = "2026_05_26_topoff"
...
for asset in ["btc", "eth", "sol"]:
    ...
    # Force float32 for price/size cols (matches existing convert pattern)
    ...
    print(f"  wrote {dst.name} ({sz:.0f} MB)")
print("\nDone.")
