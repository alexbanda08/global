...
# anchored at FIRE_us hour (NOT at_ts hour). Original 2026-05-22 table used
# the wrong anchor — see TV_AGENT_PHASE34_FIXES_2026_05_22.md §2.3.
# Refresh schedule: monthly via strategy_lab/markov_filter/_recompute_hod_top8.py.
